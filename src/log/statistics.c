...
STAT_INFO g_stat_infos[] = {
    ...
    {"zone.c", "mod_zone", "get_zone_cfg", "525"},
    {"zone.c", "mod_zone", "get_zone_cfg", "529"},
    ...
    {"zone.c", "mod_zone", "get_rr", "561"},
    {"zone.c", "mod_zone", "get_rr", "567"},
    {"zone.c", "mod_zone", "get_rr", "581"},
    {"zone.c", "mod_zone", "get_zone", "544"},
    {"zone.c", "mod_zone", "get_zone", "554"},
