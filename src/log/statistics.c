...
STAT_INFO g_stat_infos[] = {
    ...
    {"zone.c", "mod_zone", "get_arr_index_by_type", "607"},
    {"zone.c", "mod_zone", "get_arr_index_by_type", "610"},
    {"zone.c", "mod_zone", "get_zone_cfg", "544"},
    {"zone.c", "mod_zone", "get_zone_cfg", "548"},
    {"zone.c", "mod_zone", "get_zone_cfg", "558"},
    ...
    {"zone.c", "mod_zone", "get_rr", "587"},
    {"zone.c", "mod_zone", "get_rr", "601"},
    {"zone.c", "mod_zone", "get_zone", "564"},
    {"zone.c", "mod_zone", "get_zone", "574"},
