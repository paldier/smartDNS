...
STAT_INFO g_stat_infos[] = {
    ...
    {"engine.c", "mod_engine", "send_pkt", "151"},
    {"zone_query.c", "mod_zone", "pass_acl", "15"},
    {"zone.c", "mod_zone", "get_arr_index_by_type", "648"},
    {"zone.c", "mod_zone", "get_arr_index_by_type", "651"},
    {"sort.c", "mod_sort", "sort_answer", "50"},
    {"sort.c", "mod_sort", "sort_answer", "67"},
    {"sort.c", "mod_sort", "sort_answer", "75"},
    {"sort.c", "mod_sort", "sort_answer", "99"},
